...
//  HaritalarUygulamasi
//
//  Created by Bora Gündoğu on 24.03.2022.
//
...
class MapsViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        if pinView == nil {
            ...
            pinView?.canShowCallout = true // ekstra bir şey gösterme buton vs.
            ...
            CLGeocoder().reverseGeocodeLocation(requestLocation) { placemarkDizisi, hata in
                if let placemarks = placemarkDizisi {
                    if placemarks.count > 0 {
                        ...
                        item.name = self.annotationTitle // kod blokları altında karışıklık olmaması için self. şeklinde annotation belirtilir.
